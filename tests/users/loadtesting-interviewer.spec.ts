...
test("LoadTesting - Interviewer - TC72221", async ({ page, context }) => {
  ...
  await test.step(`Click "Job Posting"`, async () => {
    await page.locator("//H1[contains(text(),\"Job Posting\")]").nth(0).click();
  });
  ...
  await test.step(`Click "Join Interview Room"`, async () => {
    await page.locator("//a[normalize-space() = \"Join Interview Room\"]").nth(0).click();
    await page.waitForTimeout(5000);
