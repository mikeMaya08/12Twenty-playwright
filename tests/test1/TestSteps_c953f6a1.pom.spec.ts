...
test("Students &amp; Alumni - Search an Active student - Admin", async ({ page, context }) => {
  ...
  await page.locator("span.selected-filter__toggle-chevron>i.fa.fa-caret-down").nth(1).click();
  await page.waitForLoadState('load');
  await page.locator("span.selected-filter__toggle-chevron>i.fa.fa-caret-down").nth(1).click();
  ...
  await page.waitForLoadState('load');
  await page.locator("//dt[contains(text(),\"Active\")]/following-sibling::dd[normalize-space()=\"Yes\"]").hover();
});
