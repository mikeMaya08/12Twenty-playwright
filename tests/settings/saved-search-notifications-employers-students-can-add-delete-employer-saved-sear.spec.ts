...
test("Saved Search Notifications - Employers - Students can add/delete employer saved search - TC60477", async ({ page, context }) => {
  let selector = `0`;
  ...
  await test.step(`Fill "12twenty, Inc"`, async () => {
    await page.locator(INPUT_EMPLOYER_NAME).nth(0).fill("12twenty, Inc");
  });
  ...
  await test.step(`Fill "12twenty search"`, async () => {
    await page.locator("//INPUT[@type='text'][@id='input-iudn3n-text'][@name='name'][@placeholder='Saved Search Name']").nth(0).fill("12twenty search");
  });
  ...
  await test.step(`Hover "12twenty search"`, async () => {
    await page.locator("//SPAN[normalize-space() = \"12twenty search\"]").nth(0).hover();
  });

  await test.step(`Click "12twenty search"`, async () => {
    await page.locator("//SPAN[normalize-space() = \"12twenty search\"]").nth(0).click();
  });

  await test.step(`Hover "12twenty, Inc."`, async () => {
    await page.locator("//A[contains(text(),\"12twenty, Inc.\")]").nth(0).hover();
  });

  await test.step(`Click "12twenty search"`, async () => {
    await page.locator("//SPAN[contains(text(),\"12twenty search\")]").nth(0).click();
  });
  ...
  await test.step(`Hover "12twenty search"`, async () => {
    await page.locator("//SPAN[normalize-space() = \"12twenty search\"]//following::button[@title=\"Update\"]").nth(0).hover();
  });

  await test.step(`Click "12twenty search"`, async () => {
    await page.locator("//SPAN[normalize-space() = \"12twenty search\"]//ancestor::li//button[@title=\"Delete\"]").nth(0).click();
  });
  ...
  await test.step(`Set selector`, async () => {
    selector = "//SPAN[normalize-space() = \"12twenty search\"]";
  });
